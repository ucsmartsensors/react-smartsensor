...
export default class Menu extends Component{
    ...
    componentWillMount() {
        sessionStorage.getItem('shippingId') ? this.fetchMenuList() : false;
    }

    fetchMenuList = async () => {
        API.get('prod-smartscale-app-api','/search'+ sessionStorage.getItem('shippingId') + '/search')
            .then(data => {
                console.log(data);
                this.setState({
                    myTableData: data
    ...
    render() {
        const currentOrder = sessionStorage.getItem('currentRestaurant');
